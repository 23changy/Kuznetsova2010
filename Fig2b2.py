...
def init_cell():
    ...
    stimobj.delay = 4000 # ms, time after start of sim when you want the current injection to begin
    stimobj.dur = 1000 # ms, duration of current pulse
